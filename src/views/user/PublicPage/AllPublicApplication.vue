<template>
  <div class="container">
    <h3 class="p-3 text-center">Public Document</h3>
    ...
    <table class="table table-striped table-bordered">
      ...
      <tbody>
        <tr v-for="application in paginatedItems" :key="application.id">
          ...
          <td>
            <span v-if="application.status === 2" class="badge bg-success">Finished</span>
          </td>
          <td>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div id="content-application">
            ...
            <div v-if="application.file_id == null" v-html="application.content"></div>
            <div v-else>
              <div class="pdf-view">
        ...
        <div class="modal-footer">
          <div>
            <div v-if="application.sender_id === userId">
  ...
  methods: {
    ...
    async deleteApplication(id) {
      try {
        ...
        successToast("Delete application successfully");
        this.closeModal();
      } catch (err) {
    ...
    unpublicApplication(id) {
      ApiService.unpublicApplication(id)
        .then(() => {
          successToast("Unpublic application successfully");
          this.closeModal();
          // cập nhật lại trạng thái
          ApiService.getPublicApplication()
            .then((res) => {
        ...
        .catch(() => {
          errorToast("Unpublic application fail");
        });
    },
