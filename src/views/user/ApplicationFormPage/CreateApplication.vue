<template>
  <div class="container">
    ...
    <div class="inputs">
      ...
      <button class="btn btn-primary" @click="addToDraft">Save to draft</button>
...
export default {
  ...
  methods: {
    ...
    async addToDraft() {
      this.contentData = this.$refs.editor.editor.getHTML().replace(/<img[^>]*>/g, '');
      ...
      ApiService.addApplication(applicationData)
        .then(() => {
          successToast("Save to draft successfully");
          setTimeout(() => {
            this.$router.replace({
        ...
        .catch(() => {
          errorToast("Add document failed");
        });
    ...
    async addApplication() {
      ...
      await ApiService.addFile(pdfAsString)
        .then((response) => {
          this.contentData = response.data.urlFile;
      ...
      ApiService.addApplication(applicationData)
        .then((response) => {
          ...
          successToast("Submit document successfully");
